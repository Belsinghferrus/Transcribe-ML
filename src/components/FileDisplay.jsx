...
const FileDisplay = (props) => {
  ...
  return (
    <main className='flex-1  p-4 flex flex-col text-center gap-3 sm:gap-4 md:gap-5 justify-center pb-20 w-72 sm:w-72 max-w-full mx-auto'>
        ...
        <div className='flex flex-col text-left my-4'>
            ...
            <p>{file ? file?.name : "Custom name"}</p>
        </div>
